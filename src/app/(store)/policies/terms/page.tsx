    ...
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-6 text-muted-foreground">
        ...
        <p>
          ...
          accordance with these terms. You must not misuse the website or
        ...
        <p>
          We strive to display accurate product information, imagery, and
          specifications. Product information may change as the catalog is
          updated; contact us if you need confirmation about a specific item.
        </p>
